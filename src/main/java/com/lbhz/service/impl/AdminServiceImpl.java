...
public class AdminServiceImpl implements AdminService {
    ...
    @Override
    public BaseResult queryRecordList(Integer page, Integer pageSize, Integer weekNum, String name, String major, String studentId) {
        List<AdminListVo> adminListVos = adminMapper.queryRecordList((page - 1) * pageSize, pageSize, weekNum, name, major, studentId);
        Long total = adminMapper.countList(weekNum, name, major, studentId);
